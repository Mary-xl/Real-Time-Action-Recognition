...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def set_ui(self):
        ...
        self.setWindowTitle(u'Real time online tracking and action recognition')
    ...
    def button_event(self):
        ...
        if sender == self.button_mode_1 and self.timer_camera.isActive():
            ...
            if self.timer_camera.isActive() == False:
                ...
                if flag == False:
                    msg = QtWidgets.QMessageBox.warning(self, u"Warning", u"Please check connection",
                ...
                self.infoBox.setText(u'Camera OFF')
    ...
    def show_camera(self):
        ...
        if ret:
            if self.__flag_mode == 1:
                ...
                self.infoBox.setText(u'Action Recognition Mode')
                humans = poseEstimator.inference(show)
                ori = np.copy(show)
                show, joints, bboxes, xcenter, sk= TfPoseEstimator.get_skeleton(show, humans, imgcopy=False)
                height = show.shape[0]
    ...
    def closeEvent(self, event):
        ...
        msg = QtWidgets.QMessageBox(QtWidgets.QMessageBox.Warning, u"OFF", u"EXIT?")
